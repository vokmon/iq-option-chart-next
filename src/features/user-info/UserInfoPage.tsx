...
import IQOptionLogo from "@/assets/iqoption-logo-white.svg";
  ...
  return (
    <div className="max-w-lg mx-auto">
      <div className="mb-3">
        ...
        <Text size="md" ta="center" c="dark.1">
      ...
      <Paper
        p="xs"
        withBorder
        className="mt-4 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20"
      >
